...
3. In a new browser copy and paste this link 'https://unabolished-superenergetic-nelle.ngrok-free.dev/garmin/oauth'
...
1. If you are getting a 403 Forbidden, run curl -I http://localhost:5050/garmin/oauth and check the output
- The output is 403 Forbidden, run:
pkill ngrok
pkill -f flask
